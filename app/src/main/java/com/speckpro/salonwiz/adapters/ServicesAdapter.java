...
import com.speckpro.salonwiz.ui.services.ServiceDetailActivity;
...
public class ServicesAdapter extends RecyclerView.Adapter<ServicesAdapter.Viewholder>{
    ...
    private final ArrayList<ServicesModel> courseModelArrayList;
    DatePickerDialog datePickerDialog;
    String dirPath, fileName;

    // Constructor
    public ServicesAdapter(Context context, ArrayList<ServicesModel> courseModelArrayList) {
    ...
    public void onBindViewHolder(@NonNull ServicesAdapter.Viewholder holder, int position) {
        ...
        ServicesModel model = courseModelArrayList.get(position);
        ...
        holder.cardViewService.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent s=new Intent(context, ServiceDetailActivity.class);
