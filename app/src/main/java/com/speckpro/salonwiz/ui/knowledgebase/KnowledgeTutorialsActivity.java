...
public class KnowledgeTutorialsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 19 && Build.VERSION.SDK_INT < 21) {
            setWindowFlag(KnowledgeTutorialsActivity.this, WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS, true);
        }
        if (Build.VERSION.SDK_INT >= 19) {
            KnowledgeTutorialsActivity.this.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_STABLE | View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN);
        }
        if (Build.VERSION.SDK_INT >= 21) {
            setWindowFlag(KnowledgeTutorialsActivity.this, WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS, false);
            KnowledgeTutorialsActivity.this.getWindow().setStatusBarColor(Color.TRANSPARENT);
        }
        setContentView(R.layout.activity_knowledge_tutorial);
        ...
        recyclerViewKnowledge = findViewById(R.id.recyclerView_knowledgeTutorials);
    ...
    private void getTutorials(){
        ...
        Call<ArrayList<KnowledgeModel>> call = apiService.getKnowledgebase("application/json", "Bearer "+token, "tutorial");
            ...
            public void onResponse(Call<ArrayList<KnowledgeModel>> call, Response<ArrayList<KnowledgeModel>> response) {
                if(response.isSuccessful()){
                    ...
                    if (knowledgeArrayList!=null && knowledgeArrayList.isEmpty()) {
                        ...
                        recyclerViewKnowledge.setVisibility(View.GONE);
                        textViewNoData.setText("No Tutorials Found!");
//                        Toast.makeText(KnowledgeArticlesActivity.this, "No Articles Found!", Toast.LENGTH_SHORT).show();
                        ...
                        mAdapter = new KnowledgeAdapter(KnowledgeTutorialsActivity.this, knowledgeArrayList);
                    ...
                    textViewNoData.setVisibility(View.VISIBLE);
                    recyclerViewKnowledge.setVisibility(View.GONE);
                    textViewNoData.setText("Something went Wrong, Couldn't load Tutorials!");
...
//                Log.d("TAG",""+t.toString());
                textViewNoData.setText("Check your internet connection, Load Tutorials Failed!");
                Toast.makeText(KnowledgeTutorialsActivity.this, "" + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }

//    public void getTutorials(){
//        final ProgressDialog progressDialog = new ProgressDialog(KnowledgeTutorialsActivity.this);
...
////                                mAdapter = new KnowledgeAdapter(KnowledgeTutorialsActivity.this,data);
