...
public class SupplierInvoicesActivity extends AppCompatActivity {

    private RecyclerView recyclerViewInvoices;
    private UtilitiesAdapter utilitiesAdapter;
    private ArrayList<FilingModel> invoicesArrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_supplier_invoices);

        apiService = ApiClient.getClient().create(ApiService.class);
        progressBar = findViewById(R.id.progressBar_filinginvoices);
        textViewNoData = findViewById(R.id.textView_noDataInvoice);
        recyclerViewInvoices = findViewById(R.id.recyclerView_Invoices);
...
//        email = sh.getString("email", "");
        ...
        dateButton = findViewById(R.id.supplierinvoices_datePickerButton);
        String searchdate=dateButton.getText().toString();

        search=findViewById(R.id.supplierinvoices_searchtext);
        ...
        generalupload=findViewById(R.id.supplierinvoices_uploadbtn);
        generalupload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent s = new Intent(SupplierInvoicesActivity.this, AddSupplierInvoices.class);
                startActivity(s);
            }
        });
    ...
    protected void onRestart() {
        ...
        getSupplierFilingsSearchCalendar(scompdate, search.getText().toString(), true);
    }
    ...
    private void initDatePicker()
    {
        DatePickerDialog.OnDateSetListener dateSetListener = new DatePickerDialog.OnDateSetListener()
        {
            ...
            public void onDateSet(DatePicker datePicker, int year, int month, int day)
            {
                ...
                getSupplierFilingsSearchCalendar(scompdate, search.getText().toString().toLowerCase(), true);
            }
        };
    ...
    private void getSupplierFilings(){
        invoicesArrayList.clear();
        progressBar.setVisibility(View.VISIBLE);
        textViewNoData.setVisibility(View.GONE);
        recyclerViewInvoices.setVisibility(View.GONE);

        Call<ArrayList<FilingModel>> call = apiService.getAllFilings( "application/json", "Bearer "+token, "Supplier");
            ...
            public void onResponse(Call<ArrayList<FilingModel>> call, retrofit2.Response<ArrayList<FilingModel>> response) {
                if(response.isSuccessful()){
                    ...
                    for (int i = 0; i < response.body().size(); i++) {
                        invoicesArrayList.add(new FilingModel(
                    ...
                    if (invoicesArrayList!=null && invoicesArrayList.isEmpty()) {
                        ...
                        recyclerViewInvoices.setLayoutManager(new GridLayoutManager(SupplierInvoicesActivity.this,2));
                        utilitiesAdapter = new UtilitiesAdapter(SupplierInvoicesActivity.this, invoicesArrayList);
                        recyclerViewInvoices.setAdapter(utilitiesAdapter);
                    }
                } else {
                    progressBar.setVisibility(View.GONE);
                    textViewNoData.setVisibility(View.VISIBLE);
    ...
    private void getSupplierFilingsSearch(String searchtext){
        invoicesArrayList.clear();
        progressBar.setVisibility(View.VISIBLE);
        textViewNoData.setVisibility(View.GONE);
        recyclerViewInvoices.setVisibility(View.GONE);
    ...
    private void getSupplierFilingsSearchCalendar(String scompdate, String searchtext, boolean b){
        invoicesArrayList.clear();
        progressBar.setVisibility(View.VISIBLE);
        textViewNoData.setVisibility(View.GONE);
        recyclerViewInvoices.setVisibility(View.GONE);
