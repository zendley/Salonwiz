...
public class AddGenealDocument extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = findViewById(R.id.progressBar_addGeneral);
                ...
                if (checkPermission()) {
                    try {
                        ...
                        if (hasPerm == PackageManager.PERMISSION_GRANTED) {
                            ...
                            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(AddGenealDocument.this);
                            ...
                            Toast.makeText(AddGenealDocument.this, "Camera Permission error", Toast.LENGTH_SHORT).show();
                    } catch (Exception e) {
                        Toast.makeText(AddGenealDocument.this, "Camera Permission error", Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    }
            ...
            public void onClick(View v) {
                if(fileType.equals("Image")) {
                    ...
                    if (!filename.getText().toString().isEmpty()) {
                        ...
                        addGeneralDoc(path, title, "General");
                    } else {
                        Toast.makeText(AddGenealDocument.this, "Please Enter Filename", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    if(!filename.getText().toString().isEmpty()) {
                        title = filename.getText().toString().trim();
    ...
    private void openDocFile() { //Uri pickerInitialUri
    ...
    private void addGeneralDoc(String filePath, String title, String category){
        ...
        call.enqueue(new Callback<ApiResponse>() {
            ...
            public void onResponse(Call<ApiResponse> call, Response<ApiResponse> response) {
                if(response.isSuccessful()) {
                    if(response.body().getMessage().equals("Added Successfully")){
                        ...
                        Toast.makeText(AddGenealDocument.this, "General Document Added Successfully!", Toast.LENGTH_SHORT).show();
                        finish();
                    } else {
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(AddGenealDocument.this, "Failed to Add General Document!", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                } else {
                    Toast.makeText(AddGenealDocument.this, "Something Went Wrong, Couldn't add General Document!", Toast.LENGTH_SHORT).show();
                    progressBar.setVisibility(View.GONE);
                }
            }
            ...
            public void onFailure(Call<ApiResponse> call, Throwable t) {
                Toast.makeText(AddGenealDocument.this, "Failed to add General Document, Due to "+t.getMessage(), Toast.LENGTH_SHORT).show();
                progressBar.setVisibility(View.GONE);
            }
        });
    }
        ...
        try {
            if (requestCode ==1) {
                if (resultCode == RESULT_OK) {
                    ...
                    Uri selectedImage = getImageUri(AddGenealDocument.this,photo);
