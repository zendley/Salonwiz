...
import com.speckpro.salonwiz.retrofit.userutilitiesretrofitapi;
...
public class UtilitySelectedCards extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_utility_selectedcards);
    ...
    public void popup(String title){
        ...
        final Dialog dialog = new Dialog(UtilitySelectedCards.this);
       ...
       // registermodelclass modal = new registermodelclass(sfname, slname,semail,spass,spnumber,sbuisnessname,sbuisnessaddress,postcode);
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if(response!=null){
                Toast.makeText(UtilitySelectedCards.this, "Data added to API", Toast.LENGTH_SHORT).show();
                Log.d("TAG", "onResponse: "+response.body());
                Log.d("Response Message", "onResponse: "+response.message());
                }else{
                    Toast.makeText(UtilitySelectedCards.this, "Data not added,Contact to Speckpro", Toast.LENGTH_SHORT).show();
                }
         ...
         //       registermodelclass responseFromAPI = response.body();
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                ...
                Toast.makeText(UtilitySelectedCards.this, "Failed"+t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
