...
import com.speckpro.salonwiz.adapters.SliderAdapter;
import com.speckpro.salonwiz.ui.utilitydeals.UtilityDealsMain;
import com.speckpro.salonwiz.ui.filingcabinet.FilingCabinetActivity;
...
public class HomeFragment extends Fragment {
   ...
   // SlideViewPagerAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        SharedPreferences sh =  this.getActivity().getSharedPreferences("MySalonSharedPref", MODE_PRIVATE);
...
//        viewPager.setAdapter(adapter);
        ...
        utilitylinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getContext(), UtilityDealsMain.class);
                startActivity(i);
            }
        });
        ...
        filin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getContext(), FilingCabinetActivity.class);
                startActivity(i);
            }
        });
