...
public class AddUtilityBills extends AppCompatActivity {

    CardView browsedocument;
    ImageView imagetoshow;
    Button savedocument;
    private String path,currentdate,title;
    EditText filename;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_utilitybills);

        apiService = ApiClient.getClient().create(ApiService.class);
        progressBar = findViewById(R.id.progressBar_addUtility);
                ...
                if (checkPermission()) {
                    try {
                        ...
                        if (hasPerm == PackageManager.PERMISSION_GRANTED) {
                            ...
                            androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(AddUtilityBills.this);
                            ...
                            Toast.makeText(AddUtilityBills.this, "Camera Permission error", Toast.LENGTH_SHORT).show();
                    } catch (Exception e) {
                        Toast.makeText(AddUtilityBills.this, "Camera Permission error", Toast.LENGTH_SHORT).show();
                        e.printStackTrace();
                    }
            ...
            public void onClick(View v) {
                if(fileType.equals("Image")) {
                    if (!filename.getText().toString().isEmpty()) {
                        ...
                        addUtility(path, title, "Utiltity");
                    } else {
                        Toast.makeText(AddUtilityBills.this, "Please Enter Filename", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    if(!filename.getText().toString().isEmpty()) {
                        title = filename.getText().toString().trim();
                        addUtility(path, title, "Utility");
                    } else {
                        Toast.makeText(AddUtilityBills.this, "Please Enter Filename", Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    private void addUtility(String filePath, String title, String category){
        ...
        call.enqueue(new Callback<ApiResponse>() {
            ...
            public void onResponse(Call<ApiResponse> call, Response<ApiResponse> response) {
                if(response.isSuccessful()){
                    if(response.body().getMessage().equals("Added Successfully")){
                        ...
                        Toast.makeText(AddUtilityBills.this, "Utility Bill Added Successfully!", Toast.LENGTH_SHORT).show();
                        finish();
                    } else {
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(AddUtilityBills.this, "Failed to Add Utility Bill!", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                } else {
                    Toast.makeText(AddUtilityBills.this, "Something Went Wrong, Couldn't add Utility Bill!", Toast.LENGTH_SHORT).show();
                    progressBar.setVisibility(View.GONE);
                }
            }
            ...
            public void onFailure(Call<ApiResponse> call, Throwable t) {
                Toast.makeText(AddUtilityBills.this, "Failed to add Utility Bill, Due to "+t.getMessage(), Toast.LENGTH_SHORT).show();
                progressBar.setVisibility(View.GONE);
            }
        });
    }
        ...
        try {
            if (requestCode ==1) {
                if (resultCode == RESULT_OK) {
                    ...
                    Uri selectedImage = getImageUri(AddUtilityBills.this,photo);
