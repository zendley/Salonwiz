...
public class FilingCabinetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filing_cabinet);
        ...
        cardUtilityBills.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(FilingCabinetActivity.this, UtilityBillsActivity.class);
                startActivity(i);
            }
        });
        ...
        cardSupplierInvoices.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent a = new Intent(FilingCabinetActivity.this, SupplierInvoicesActivity.class);
                startActivity(a);
            }
        });
        ...
        cardGeneralDocs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent s = new Intent(FilingCabinetActivity.this, GeneralDocumentsActivity.class);
                startActivity(s);
            }
        });
    }
