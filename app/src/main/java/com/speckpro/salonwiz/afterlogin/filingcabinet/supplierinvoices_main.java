...
import com.speckpro.salonwiz.afterlogin.filingcabinet.generalcard.gencard_adapter;
import com.speckpro.salonwiz.afterlogin.filingcabinet.generalcard.gencard_model;
...
public class supplierinvoices_main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_supplierinvoices_main);
        ...
        generalupload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent s = new Intent(supplierinvoices_main.this, supplierinvoices_uploadfile.class);
                startActivity(s);
            }
        });
...
//    }
    ...
    public void getdata(String email){
        data.clear();
        courseRVs = findViewById(R.id.supplierinvoices_recycler);
                ...
                new Response.Listener<JSONObject>()
                {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                                ...
                                gencard_adapter courseAdapters = new gencard_adapter(supplierinvoices_main.this, data);
                                courseRVs.setLayoutManager(new GridLayoutManager(supplierinvoices_main.this,3));
    ...
    public void getdataforsearchcalender(String email,String date,boolean s){
        ...
        courseRV = findViewById(R.id.supplierinvoices_recycler);
        // data = new ArrayList<>();
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            if(!s){
                                ...
                                courseAdapter = new gencard_adapter(supplierinvoices_main.this, data);
                                courseRV.setLayoutManager(new GridLayoutManager(supplierinvoices_main.this,3));
                                ...
                                for(int i=0;i<result.length();i++){
                                    ...
                                    if(cdate.equals(date)&&asd.equals(userdata.getString("Type"))){
                                        ...
                                        data.add(new gencard_model(correcturl,Title,id));
                                        Log.d("Response", correcturl+"             "+Title);}}
                                gencard_adapter courseAdapter = new gencard_adapter(supplierinvoices_main.this, data);
                                courseRV.setLayoutManager(new GridLayoutManager(supplierinvoices_main.this,3));
                                courseRV.setAdapter(courseAdapter);
