...
public class service_basic extends AppCompatActivity {
    ...
    private void postData(String userid, String Date, String packagename) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(service_basic.this);
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if(response!=null){
                    ...
                    Toast.makeText(service_basic.this, "Package Request Sent Successfully!", Toast.LENGTH_SHORT).show();
                    finish();
//                    Intent intent=new Intent(getApplicationContext(),services.class);
//                    intent.putExtra("packagestatus","basicPending");
//                    startActivity(intent);
                }else{
                    Toast.makeText(service_basic.this, "Data not added, Contact to Speckpro", Toast.LENGTH_SHORT).show();
                }
            }
            @Override
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                Toast.makeText(service_basic.this, "Failed"+t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
