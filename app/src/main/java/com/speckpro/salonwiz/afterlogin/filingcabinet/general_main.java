...
public class general_main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        generalupload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent s = new Intent(general_main.this, general_uploadfile.class);
                startActivity(s);
            }
        });
...
//    }
    ...
    public void getdata(String email){
        courseRVs = findViewById(R.id.general_recycler);
                ...
                new Response.Listener<JSONObject>()
                {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                                ...
                                gencard_adapter courseAdapters = new gencard_adapter(general_main.this, data);
                                courseRVs.setLayoutManager(new GridLayoutManager(general_main.this,3));
                ...
                new Response.Listener<JSONObject>()
                {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            courseAdapters = new gencard_adapter(general_main.this, data);
                            courseRVs.setLayoutManager(new GridLayoutManager(general_main.this, 3));
                            courseRVs.setAdapter(courseAdapters);
                        } catch (JSONException e) {
                            e.printStackTrace();
    ...
    public void getdataforsearchcalender(String email,String date,boolean s){
        ...
        courseRV = findViewById(R.id.general_recycler);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            if(!s){
                                ...
                                courseAdapter = new gencard_adapter(general_main.this, data);
                                courseRV.setLayoutManager(new GridLayoutManager(general_main.this,3));
                                ...
                                gencard_adapter courseAdapter = new gencard_adapter(general_main.this, data);
                                courseRV.setLayoutManager(new GridLayoutManager(general_main.this,3));
                                courseRV.setAdapter(courseAdapter);
