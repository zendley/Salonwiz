...
import com.speckpro.salonwiz.afterlogin.UI.homefrag_utilitydeals.update_utilityformfilling;
import com.speckpro.salonwiz.afterlogin.UI.homefrag_utilitydeals.utilityformfilling;
...
public class cardadapter extends RecyclerView.Adapter<cardadapter.Viewholder>{
    ...
    // Constructor
    public cardadapter(Context context, ArrayList<card_model> courseModelArrayList) {
        ...
        holder.fillform.setOnClickListener(new View.OnClickListener() {
           ...
           // holder.fillform.setClickable(true);
            ...
            holder.fillform.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(v.getContext(), update_utilityformfilling.class);
                    intent.putExtra("title",model.getText());
                    v.getContext().startActivity(intent);
                }
            });
