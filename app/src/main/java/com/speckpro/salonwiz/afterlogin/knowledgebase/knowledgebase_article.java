...
public class knowledgebase_article extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 19 && Build.VERSION.SDK_INT < 21) {
            setWindowFlag(knowledgebase_article.this, WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS, true);
        }
        if (Build.VERSION.SDK_INT >= 19) {
            knowledgebase_article.this.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_STABLE | View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN);
        }
        if (Build.VERSION.SDK_INT >= 21) {
            setWindowFlag(knowledgebase_article.this, WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS, false);
            knowledgebase_article.this.getWindow().setStatusBarColor(Color.TRANSPARENT);
        }
        setContentView(R.layout.activity_knowledgebase_article);
    ...
    public void getfaqs(){
        final ProgressDialog progressDialog = new ProgressDialog(knowledgebase_article.this);
                    ...
                    if(message.equals("Files Found")){
                        for (int i=0;i<result.length();i++){
                            ...
                            if(userdata.getString("Type").equals("Articles")){
                                ...
                                mAdapter = new faq_adapter(knowledgebase_article.this,data);
