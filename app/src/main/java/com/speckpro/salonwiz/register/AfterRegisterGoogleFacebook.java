...
public class AfterRegisterGoogleFacebook extends AppCompatActivity {
        ...
        aftefbgooglelgsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ((!terms.isChecked())||postcode.getText().toString().isEmpty() || fbpnumber.getText().toString().isEmpty()|| buisnessname.getText().toString().isEmpty()|| buisnessaddress.getText().toString().isEmpty()) {
                    Toast.makeText(AfterRegisterGoogleFacebook.this, "Please dont leave blank values", Toast.LENGTH_SHORT).show();
                } else{
    ...
    private void postData(String sfname,String slname,String semail,String spnumber,String sbuisnessname,String sbuisnessaddress,String postcode) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(AfterRegisterGoogleFacebook.this);
        ...
        call.enqueue(new Callback<fbgregistermodelclass>() {
            ...
            public void onResponse(Call<fbgregistermodelclass> call, Response<fbgregistermodelclass> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    Intent intent=new Intent(AfterRegisterGoogleFacebook.this, Login.class);
                    startActivity(intent);
                }
                else{
                    Toast.makeText(AfterRegisterGoogleFacebook.this, "Failed", Toast.LENGTH_SHORT).show();
                }
                fbgregistermodelclass responseFromAPI = response.body();
            }
            @Override
            public void onFailure(Call<fbgregistermodelclass> call, Throwable t) {
                Toast.makeText(AfterRegisterGoogleFacebook.this, "Failed"+t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public boolean validate() {
        boolean temp=true;
        if(!terms.isChecked()){
            Toast.makeText(AfterRegisterGoogleFacebook.this,"Please accept terms",Toast.LENGTH_SHORT).show();
            temp=false;
        }
        return temp;
    }
