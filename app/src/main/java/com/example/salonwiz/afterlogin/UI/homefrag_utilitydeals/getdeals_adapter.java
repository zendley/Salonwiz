...
public class getdeals_adapter extends RecyclerView.Adapter<getdeals_adapter.Viewholder>{

    private final Context context;
    private final ArrayList<model_getdeals> courseModelArrayList;

    // Constructor
    public getdeals_adapter(Context context, ArrayList<model_getdeals> courseModelArrayList) {
    ...
    @NonNull
    @Override
    public getdeals_adapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // to inflate the layout for each item of recycler view.
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_getdealrender, parent, false);
        return new getdeals_adapter.Viewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull getdeals_adapter.Viewholder holder, int position) {
