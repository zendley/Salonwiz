...
import com.example.salonwiz.afterlogin.knowledgebase.knowledgebase_article;
...
public class services extends AppCompatActivity {
    ...
    private ArrayList<mode_services> data;
...
//                            if(userdata.getString("Type").equals("Articles")){
                            // JSONObject Utilities=userdata.getJSONObject("Utilities");
                                ...
                                mode_services st =new mode_services(title, amount, duration);
                                data.add(st);

                            recyclerViewServices =findViewById(R.id.recyclerView_services);
                            recyclerViewServices.setHasFixedSize(true);
                            LinearLayoutManager layoutManager = new LinearLayoutManager(services.this);
                            recyclerViewServices.setLayoutManager(layoutManager);
                            servicesAdapter = new ServicesAdapter(services.this, data);
