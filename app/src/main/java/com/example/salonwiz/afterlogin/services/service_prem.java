...
public class service_prem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_service_prem);
        ...
        getpackage=findViewById(R.id.mpmarket_basicpackagebtn);
    ...
    private void postData(String userid, String Date, String packagename) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(service_prem.this);
       ...
       call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if(response!=null){
                    ...
                    Toast.makeText(service_prem.this, "Package Request Sent Successfully!", Toast.LENGTH_SHORT).show();
                    finish();
//                    Intent intent=new Intent(getApplicationContext(),services.class);
//                    intent.putExtra("packagestatus","premPending");
//                    startActivity(intent);
                }else{
                    Toast.makeText(service_prem.this, "Data not added, Contact to Speckpro", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                Toast.makeText(service_prem.this, "Failed"+t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
